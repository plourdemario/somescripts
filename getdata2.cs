...
namespace GetData
{
    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            string connstring1 = "server=localhost;uid=root;pwd=fakepassword;database=Investment_Leads;CharSet=utf8;";
	...
	class UserListing
	{
		...
		public void SendEmail()
		{
			...
			{
				Port = 587,
				Credentials = new NetworkCredential("noreply@aqesda.com", "fakepassword"),
				EnableSsl = true,
			};
